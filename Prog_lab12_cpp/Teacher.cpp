...
void operator<<(ostream& smth, Teacher operandTeacher)
{
	cout << "working experience: " << operandTeacher.workExp << " years" << endl;
	cout << "scientific degree: " << operandTeacher.degree << endl;
	cout << "faculty name: " << operandTeacher.facultyName << endl;
	cout << operandTeacher.humanField;
}
